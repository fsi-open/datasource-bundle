...
namespace FSi\Bundle\DataSourceBundle\DataSource\Extension\Configuration;
...
class ConfigurationLoader
{
    ...
    private function importResource($configuration, $resource, BundleInterface $contextBundle)
    {
        ...
        $configuration['fields'] = array_replace_recursive(
            $configuration['fields'],
            $importedConfiguration['fields']
        );

        $nestedConfiguration = $this->load($importedConfiguration, $contextBundle);
        $configuration['fields'] = array_replace_recursive(
            $configuration['fields'],
            $nestedConfiguration['fields']
        );
